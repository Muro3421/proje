...
ayetler = [
    ...
    "Allah, adaleti, iyiliği ve akrabaya yardım etmeyi emreder; hayasızlığı, fenalığı ve azgınlığı yasaklar. Düşünüp tutasınız diye size öğüt verir. (Nahl, 90)",
    "Ey iman edenler! Sabır ve namaz ile Allah’tan yardım dileyin. Şüphesiz Allah, sabredenlerle beraberdir. (Bakara, 153)",
    "Kim Allah’a tevekkül ederse, O, ona yeter. Allah, emrini yerine getirendir. Allah her şey için bir ölçü koymuştur. (Talak, 3)",
    "İyilikle kötülük bir olmaz. Sen kötülüğü en güzel şekilde sav. O zaman seninle arasında düşmanlık bulunan kimse, sanki candan bir dost olur. (Fussilet, 34)",
    "De ki: Ey kendilerine karşı haddi aşan kullarım! Allah’ın rahmetinden ümit kesmeyin. Çünkü Allah, bütün günahları bağışlar. Şüphesiz ki O, çok bağışlayıcı, çok merhamet edicidir. (Zümer, 53)",
    "Şüphesiz ki Allah, göklerdeki ve yerdeki her şeyi bilir. Allah, her şeyi hakkıyla bilendir. (Hucurat, 16)",
    "Demek ki, zorlukla beraber bir kolaylık var. Evet, o zorlukla beraber bir kolaylık var. (İnşirah, 5-6)",
    "İman eden ve salih ameller işleyenlere gelince, onlar için altlarından ırmaklar akan cennetler vardır. İşte büyük kurtuluş budur. (Buruc, 11)",
    "Ey Âdemoğulları! Her mescide güzel elbiselerinizi giyinerek gidin. Yiyin, için, fakat israf etmeyin. Çünkü Allah, israf edenleri sevmez. (Araf, 31)",
    "Doğu da, batı da Allah’ındır. Nereye dönerseniz dönün, Allah’ın yüzü oradadır. Şüphesiz ki Allah, her şeyi kuşatandır, hakkıyla bilendir. (Bakara, 115)",
    ...
    "Müminler ancak kardeştirler. Öyleyse kardeşlerinizin arasını düzeltin ve Allah’a karşı takva sahibi olun ki size merhamet edilsin. (Hucurat, 10)",
    "Ey iman edenler! Bir topluluk, diğer bir topluluğu alaya almasın. Belki de onlar kendilerinden daha iyidir. Kadınlar da diğer kadınları alaya almasın. Belki de onlar kendilerinden daha iyidir. (Hucurat, 11)",
    "Rabbiniz şöyle buyurmuştu: 'Eğer şükrederseniz elbette size nimetimi artırırım. Ama nankörlük ederseniz, hiç şüphesiz azabım çok çetindir. (İbrahim, 7)",
    "Gerçekten insan, kendi çalışmasından başkasını elde edemez. Ve çalışması da ileride görülecektir. (Necm, 39-40",
    "Rabbin, dualarınızı kabul eder. (Mümin, 60)",
    "Allah’ın rahmeti geniştir. (Araf, 156)",
    "Kim şükrederse, kendisi için şükretmiş olur. (Lokman, 12)",
    "Allah sizin yardımcınızdır. (Bakara, 286",
    "**Developer**\n\n  @SakirBey",
